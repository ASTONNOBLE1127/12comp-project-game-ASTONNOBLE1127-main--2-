...
function preload() {
    playerSheet = loadImage('/dungeon_divers/images/questKid.webp');
    wolfSheet = loadImage('/dungeon_divers/images/enemy/MassacreSpriteSheet.png');
    archerSheet = loadImage('/dungeon_divers/images/enemy/archer.png');
    arrowSheet = loadImage('/dungeon_divers/images/enemy/arrow.png');
    tiles = loadImage('/dungeon_divers/images/DungeonTileSet.png')
    heart = loadImage('/dungeon_divers/images/icons/heart.png')
    keyboard = loadImage('/dungeon_divers/images/uninteractables/keybinds.png')
    endScreen = loadImage('/dungeon_divers/images/uninteractables/end2.png')
    menu = loadImage('/dungeon_divers/images/buttons/menu.png')
    restart = loadImage('/dungeon_divers/images/buttons/restart.png')
    letter = loadImage('/dungeon_divers/images/uninteractables/lettersheet2.png')
    starImg = loadImage('/dungeon_divers/images/icons/star3.png')
    startImage = loadImage('/dungeon_divers/images/buttons/start.png')
    tutorialImage = loadImage('/dungeon_divers/images/buttons/tutorial.png')
    ttasr = loadImage('/dungeon_divers/images/buttons/ttasr.png')
    golemSheet = loadImage('/dungeon_divers/images/enemy/golem.png')
    lock = loadImage('/dungeon_divers/images/icons/lock.png')
    levelImg = loadImage('/dungeon_divers/images/icons/levels.png')
    planeImg = loadImage('/dungeon_divers/images/plane/ships_packed.png')
    planeTiles = loadImage('/dungeon_divers/images/plane/tiles_packed.png')
    heartRelic = loadImage('/dungeon_divers/images/relics/heartRelic.png')
    backImg = loadImage('/dungeon_divers/images/buttons/back.png')
    titleImg = loadImage('/dungeon_divers/images/title.png')
}
...
const PLAYERPOINT = [3,12,3.5,26,10.5,38,2,2]
